...
dim(bio1.chrom2.plot)
head(bio1.chrom2.plot$position)
tail(bio1.chrom2.plot$position)
...
# Save plot to PDF
pdf("circos_plot_chrom2_group1.pdf", width = 10, height = 10)  # Open PDF device
...
# Draw the heatmap
circos.heatmap(bio1.chrom2.plot[, 2:90], 
               col = col_fun1, 
               track.height = 0.8, 
               bg.border = "black", 
               bg.lwd = 1, 
...
bio1_Marker_Effects_chrom_2H <- bio1_Marker_Effects_chrom_2H %>% arrange(position)  # Sort by position
head(bio1_Marker_Effects_chrom_2H$position)  # View the first few positions
tail(bio1_Marker_Effects_chrom_2H$position)  # View the last few positions

row_100M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 100000000))
row_200M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 200000000))
row_300M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 300000000))
row_400M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 400000000))
row_500M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 500000000))
row_600M <- which.min(abs(bio1_Marker_Effects_chrom_2H$position - 600000000))

cat("Row closest to 100M:", row_100M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_100M], "\n")
cat("Row closest to 200M:", row_200M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_200M], "\n")
cat("Row closest to 300M:", row_300M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_300M], "\n")
cat("Row closest to 400M:", row_400M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_400M], "\n")
cat("Row closest to 500M:", row_500M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_500M], "\n")
cat("Row closest to 600M:", row_600M, "Position:", bio1_Marker_Effects_chrom_2H$position[row_600M], "\n")
...
# Save plot to PDF
pdf("circos_plot_chrom2_group2a.pdf", width = 10, height = 10)  # Open PDF device
...
# Save plot to PDF
pdf("circos_plot_chrom2_group3.pdf", width = 10, height = 10)  # Open PDF device
...
# Save plot to PDF
pdf("circos_plot_chrom2_group4.pdf", width = 10, height = 10)  # Open PDF device
...
# Save plot to PDF
pdf("circos_plot_chrom2_group5.pdf", width = 10, height = 10)  # Open PDF device
